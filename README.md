...
| [microsoft-arm](bridges/microsoft-arm/) | container | cloud | Azure Resource Manager (Commercial & Government) -- VMs, NSGs, storage, AVD, Arc, Key Vault, Recovery Services, SQL, monitoring, cost data via az CLI and REST API |
